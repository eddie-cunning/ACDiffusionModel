% RANDOM MODEL
% ------------------------------------------------------------
function RMfun(INt, INp, Itheta, test_num)
% Setting Variables
...
for i = 1:4
    ...
    while is_zero == 1
        ...
        if new_fibre_check(grid_zero) ~= 0
            phi(i) = rand(1) * 360;
            is_zero = 1;
        else
...
save("C:/Users/eddie/Documents/MATLAB/AC Diffusion/Data/R_Test_" + num2str(Nt) + "_" + num2str(Np) + "_" + num2str(rad2deg(theta)) + "_" + ...
